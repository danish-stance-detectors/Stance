...
X_train, X_test, y_train, y_test, emb_size = data_loader.get_train_test_split()#data_loader.get_instances(training_data, '\t')
...
model_stats.print_confusion_matrix(y_test, labels_pred, [0,1,2,3])
